...
core_proxy_v1:
  ...
  guard_word_dictionary:
    早期安心: ["消えた","未遂でよかった","安全だった","もう大丈夫","安心して"]
    規範注入: ["べき","許されない","厳守","遵守","反省","教訓","戒め","当然"]
    管理主義: ["SLA","監視UI","ダッシュボード","KPI至上","手順追加","標準プロセス","ベストプラクティス"]
    善人ラッピング: ["みんなの功績","匿名で","陰徳","とりあえず","助け合いだから","良識として"]
    所作テンプレ: ["コンコン","一拍置き","微笑んで","優しく〜","静かに頷き","目を細め","肩をすくめ"]
    過剰演出: ["魂が震える","運命的","奇跡のよう","胸が熱く","涙が溢れ","最強"]
    語義曖昧: ["自由","愛","正義","誠実","尊厳"]
...
scene_sieve:
  enabled: true
  allowed_scenes: ["監査","休憩室","取調","雑談","契約/監査事務"]
